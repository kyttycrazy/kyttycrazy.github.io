...
tags:
  ...
  - Easy
image:
  path: /assets/img/article/rootme-writeup-thm/rootme.png
---
...
![web](/assets/img/article/rootme-writeup-thm/web.png)
...
![uploads](/assets/img/article/rootme-writeup-thm/uploads.png)
...
![panel](/assets/img/article/rootme-writeup-thm/panel.png)
...
![wappalyzer](/assets/img/article/rootme-writeup-thm/wappalyzer.png)
...
![error](/assets/img/article/rootme-writeup-thm/error.png)
...
![payload_positions](/assets/img/article/rootme-writeup-thm/payload_positions.png)
...
![payload](/assets/img/article/rootme-writeup-thm/payload.png)

Desactivamos la codificación de caracteres para evitar posibles errores.

![payload_encoding](/assets/img/article/rootme-writeup-thm/payload_encoding.png)
...
![suid](/assets/img/article/rootme-writeup-thm/suid.png)
