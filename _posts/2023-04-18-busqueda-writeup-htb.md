...
tags:
  ...
  - HTTP
image:
  path: /assets/img/article/busqueda-writeup-htb/busqueda.png
---
...
![web](/assets/img/article/busqueda-writeup-htb/web.png)
...
![vuln](/assets/img/article/busqueda-writeup-htb/vuln.png)
...
![commit](/assets/img/article/busqueda-writeup-htb/commit.png)
...
![eval](/assets/img/article/busqueda-writeup-htb/eval.png)
...
![request](/assets/img/article/busqueda-writeup-htb/request.png)
...
![payload](/assets/img/article/busqueda-writeup-htb/payload.png)
