...
tags:
  ...
  - Easy
image:
  path: /assets/img/article/forest-writeup-htb/forest.png
---
...
![login](/assets/img/article/forest-writeup-htb/login.png)

Cargamos los datos del archivo `zip` que contiene los resultados recopilados por SharpHound.

![upload](/assets/img/article/forest-writeup-htb/upload.png)

Marcamos al usuario `svc-alfresco` como comprometido, ya que hemos obtenido control sobre la cuenta.

![svc-alfresco](/assets/img/article/forest-writeup-htb/svc-alfresco.png)

![svc-alfresco2](/assets/img/article/forest-writeup-htb/svc-alfresco2.png)

A partir del usuario `svc-alfresco`, seleccionamos "Objetivos de alto valor alcanzables".

![svc-alfresco3](/assets/img/article/forest-writeup-htb/svc-alfresco3.png)
...
![svc-alfresco4](/assets/img/article/forest-writeup-htb/svc-alfresco4.png)

A partir del grupo **ACCOUNT OPERATORS**, seleccionamos "Objetivos de alto valor alcanzables".

![account](/assets/img/article/forest-writeup-htb/account.png)
...
![account2](/assets/img/article/forest-writeup-htb/account2.png)
...
![WriteDacl](/assets/img/article/forest-writeup-htb/WriteDacl.png)

![WriteDacl2](/assets/img/article/forest-writeup-htb/WriteDacl2.png)
